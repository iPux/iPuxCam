...
/**
 * <p> Codec for the Quoted-Printable section of <a href="http://www.ietf.org/rfc/rfc1521.txt">RFC
 * 1521 </a>. </p> <p> The Quoted-Printable encoding is intended to represent data that largely
 * consists of octets that correspond to printable characters in the ASCII character set. It encodes
 * the data in such a way that the resulting octets are unlikely to be modified by mail transport.
 * If the data being encoded are mostly ASCII text, the encoded form of the data remains largely
 * recognizable by humans. A body which is entirely ASCII may also be encoded in Quoted-Printable to
 * ensure the integrity of the data should the message pass through a character- translating, and/or
 * line-wrapping gateway. </p>
 *
 * <p> Note: </p> <p> Rules #3, #4, and #5 of the quoted-printable spec are not implemented yet
 * because the complete quoted-printable spec does not lend itself well into the byte[] oriented
 * codec framework. Complete the codec once the steamable codec framework is ready. The motivation
 * behind providing the codec in a partial form is that it can already come in handy for those
 * applications that do not require quoted-printable line formatting (rules #3, #4, #5), for
 * instance Q codec. </p>
 *
...
public class QuotedPrintableCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
     ...
     *
     * <p> This function implements a subset of quoted-printable encoding specification (rule #1 and
     * rule #2) as defined in RFC 1521. </p>
     *
     ...
     *
     * <p> This function implements a subset of quoted-printable encoding specification (rule #1 and
     * rule #2) as defined in RFC 1521 and is suitable for encoding binary data. </p>
     *
