 ...
 * encodings are specified in <a href="http://java.sun.com/j2se/1.4.2/docs/api/java/nio/charset/Charset.html">Standard
 * charsets</a>
 *
...
public class StringUtils {
     ...
     * into a new byte array. <p> This method catches {@link UnsupportedEncodingException} and
     * rethrows it as {@link IllegalStateException}, which should never happen for a required
     * charset name. Use this method when the encoding is required to be in the JRE. </p>
     *
     * @param string      the String to encode
     ...
     * charset. <p> This method catches {@link UnsupportedEncodingException} and re-throws it as
     * {@link IllegalStateException}, which should never happen for a required charset name. Use
     * this method when the encoding is required to be in the JRE. </p>
     *
