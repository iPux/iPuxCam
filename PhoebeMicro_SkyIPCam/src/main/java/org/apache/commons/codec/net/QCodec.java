...
/**
 * <p> Similar to the Quoted-Printable content-transfer-encoding defined in <a
 * href="http://www.ietf.org/rfc/rfc1521.txt">RFC 1521</a> and designed to allow text containing
 * mostly ASCII characters to be decipherable on an ASCII terminal without decoding. </p>
 *
