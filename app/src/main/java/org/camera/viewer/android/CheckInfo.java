...
import org.camera.viewer.android.CameraInfo.CameraInfos;
...
public class CheckInfo extends Activity {
	...
	public static final String AUTHORITY = "org.camera.viewer.android.cameraprovider";
      ...
      save = (Button)findViewById(R.id.save_i);
        ...
        contact.setOnClickListener(new Button.OnClickListener()
        {
			...
			public void onClick(View arg0) {
				...
				Log.i("onContact","modelName:["+modelName+"]");
				if(modelName.equals("")){
...
//			connect.setVisibility(View.INVISIBLE);
    ...
    private String getModelName(){
		try {
			...
			//Log.i("getModelName","url:["+host.getText().toString()+"] account:["+authCombination+"]");
